...
vpc_beltran_path <- "G:/jyeung/projects/alternative_splicing/output/xenograft_exprs/pvals_db_rbps.three_cohorts_combined.custom.txt"
...
fname='G:/jyeung/projects/alternative_splicing/figs/bubble_plot_genes_in_db_only_final_with_RBFOX1_wide3.eps'
...
g <- ggplot(vpc_beltran_data, aes(x=log10_p_value.beltran, y=log10_p_value.vpc, size=abs_fold_change, fill=fc_direction), legend=FALSE) +
        geom_point(colour='black', shape=21) + scale_area(range=c(1,15)) + 
