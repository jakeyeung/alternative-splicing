...
#myfilepath <- args[1]
#Example path
#'G:/jyeung/projects/alternative_splicing/output/miso_outputs/xenographs_331_331R_hg19_v2/\
#'SE.hg19.gff3/filtered_batch/numinc_1.numexc_1.numsum_20.psi_035.both/\
#'tophat_AB331_3_PE_vs_tophat_AB331_R_3_PE.genename_appended.exprs_filtered.for_heatmap.matrix'
#outpath <- args[2]

myfilepath <- 'G:/jyeung/projects/alternative_splicing/output/miso_outputs/xenographs_331_331R_hg19_v2/SE.hg19.gff3/filtered_batch/filtered_psi_030/tophat_AB331_3_PE_vs_tophat_AB331_R_3_PE.miso_bf.genename_appended.exprs_filtered.for_heatmap.matrix'

fpath.SE <- file.path(myfilepath)
mytitle.SE <- paste0('\nCassette Exons\n')
samp1_name <- 'PCa 331'
samp2_name <- 'NEPC 331R'

se_outpath <- 'G:/jyeung/projects/alternative_splicing/figs/cassette_exons_xenograft_rev.rerun.paper.eps'
