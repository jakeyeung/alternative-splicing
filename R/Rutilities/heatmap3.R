    ...
    if (missing(lmat) || is.null(lmat)) {
        ...
        if (!missing(ColSideColors)) {
            ...
            if (!is.character(ColSideColors) || nrow(ColSideColors) != nc)
                stop(paste(nc, 
                           nrow(ColSideColors), 
                           paste('Is not char:',!is.character(ColSideColors)),
                           "'ColSideColors' must be a matrix of nrow(x) rows"))
        ...
        if (!missing(RowSideColors)) {
            ...
            if (!is.character(RowSideColors) || ncol(RowSideColors) != nr)
                stop(paste(nr, ncol(RowSideColors), "'RowSideColors' must be a matrix of ncol(x) columns"))
